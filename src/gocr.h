...
Foundation, Inc., 59 Temple Place - Suite 330, Boston, MA  02111-1307, USA.
 ...
 ToDo: rewrite gocr.h as interface to libPgm2asc 
       move the contents to other h-files, rename functions
       to unique gocr_names 
...
int num_cross(int x0, int x1, int y0, int y1,
               pix *p,  int cs);  /* 1/8 tolerance */
int num_cross_fine(int x0, int x1, int y0, int y1,
               pix *p,  int cs);  /* 1/32 tolerance */
